...
SESSION_COOKIE_AGE = 300 * 60   # cookie 保存时间(单位毫秒)
...
EMAIL_SEND_USERNAME = '284258099@qq.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = 'qwertyuiop'     # 邮箱密码
